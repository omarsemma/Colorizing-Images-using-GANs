...
from .ops import pixelwise_accuracy, preprocess, postprocess, peak_signal_to_noise_ratio
...
class BaseModel:
    ...
    def build(self):
        ...
        self.accuracy2 = pixelwise_accuracy(self.input_color, gen, self.options.color_space, self.options.acc_thresh)
        self.accuracy = peak_signal_to_noise_ratio(self.input_color, gen)
