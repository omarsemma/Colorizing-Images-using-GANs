...
class ModelOptions:
    def __init__(self):
        ...
        parser.add_argument('--batch-size', type=int, default=64, metavar='N', help='input batch size for training (default: 16)')
        ...
        parser.add_argument('--sample', type=str2bool, default=False, help='True for sampling (default: True)')
        parser.add_argument('--sample-size', type=int, default=8, help='number of images to sample (default: 8)')
        parser.add_argument('--sample-interval', type=int, default=1, help='how many batches to wait before sampling (default: 1000)')
        ...
        parser.add_argument('--log-interval', type=int, default=93, help='how many iterations to wait before logging training status (default: 10)')
